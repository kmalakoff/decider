...
async function initialize() {
  ...
  Object.values(require('require-directory')(module, './query/routes')).forEach((m) => m({app, services}));
  Object.values(require('require-directory')(module, './command/routes')).forEach((m) => m({app, services}));
